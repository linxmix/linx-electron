module.exports = {
  ...
  mod,
  getFirstBarOffsetTime,
  calculateHumanReadableTimestamp
}
...
function getFirstBarOffsetTime ({ time, bpm, timeSignature = 4 }) {
...
function calculateHumanReadableTimestamp(totalSeconds) {
